    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="mx-auto max-w-4xl rounded-xl border bg-white p-8">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link className="rounded-md border px-4 py-2" href="/jobs">
            岗位搜索
          </Link>
          <Link className="rounded-md border px-4 py-2" href="/students">
            学生导入
          </Link>
          <Link className="rounded-md border px-4 py-2" href="/match">
            匹配结果
          </Link>
        </div>
      </div>
